...
<!--         <div class="container p-5">
            <h3>Think of this as the main page of your
            application after {{ netID }} has been authenticated.</h3>
            <b-form>
                <b-button href="https://fed.princeton.edu/cas/logout" variant="primary">Log me out of this website and CAS!
                </b-button>
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <!-- Placeholder progress bar for now, will have meaninful values \
                  later when we implement completed goals -->
                <h5>Overall Goal Progress (placeholder values at the moment)</h5>
                <b-progress :value=50 :max=100 :precision="2"
                show-progress class="mb-3" variant="success"></b-progress>
                <button type="button" class="btn btn-success btn-sm"
                v-b-modal.goal-modal>Add Goal</button>
                <br><br>
        ...
        <b-modal ref="addGoalModal" id="goal-modal" title="Add a new goal" hide-footer>
            <b-form @submit="onSubmit" @reset="onReset" class="w-100">
                <b-form-group id="form-goalNumber-group"
                label="Goal Number:" label-for="form-goalNumber-input">
                    <b-form-input id="form-goalNumber-input" type="number"
                    v-model.number="addGoalForm.goalNum" required placeholder="Enter goal number">
                    </b-form-input>
                </b-form-group>
                <b-form-group id="form-goalTitle-group"
                label="Goal Title:" label-for="form-goalTitle-input">
                    <b-form-input id="form-goalTitle-input" type="text"
                    v-model="addGoalForm.goalTitle" required placeholder="Enter goal title">
                    </b-form-input>
                </b-form-group>
        ...
        <b-modal ref="updateGoalModal" id="goal-update-modal" title="Update" hide-footer>
            <b-form @submit="onSubmitUpdate" @reset="onResetUpdate" class="w-100">
                <b-form-group id="form-goalNumber-update-group"
                label="Goal Number:" label-for="form-goalNumber-update-input">
                    <b-form-input id="form-goalNumber-update-input"
                    type="number" v-model.number="updateGoalForm.goalNum"
                    required placeholder="Enter goal number">
                    </b-form-input>
                </b-form-group>
                <b-form-group id="form-goalTitle-update-group"
                label="Goal Title:" label-for="form-goalTitle-update-input">
                    <b-form-input id="form-goalTitle-update-input"
                    type="text" v-model="updateGoalForm.goalTitle"
                    required placeholder="Enter goal title">
                    </b-form-input>
                </b-form-group>
